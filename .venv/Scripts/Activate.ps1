...
# Add NASM to PATH for this virtual environment if installed in the user-local tools folder.
$nasmDir = "C:\Users\lozas\AppData\Local\bin\NASM"
if (Test-Path (Join-Path $nasmDir "nasm.exe")) {
    $Env:PATH = "$nasmDir$([System.IO.Path]::PathSeparator)$Env:PATH"
}
